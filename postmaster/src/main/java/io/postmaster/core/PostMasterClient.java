...
public class PostMasterClient {

	private static PostMasterClient _instance;
	private static String _apiKey;
	private static String _apiDomain;

	public static void initialize(String apiKey,String apiDomain){
		_apiKey = apiKey;
	...
	public static PostMasterClient getInstance() {
		if (_instance == null) {
			_instance = new PostMasterClient(_apiDomain,
					_apiKey);
		}
		return _instance;
	}
	...
	private PostMasterClient(String location, String key) {

		if(location == null || key == null){
			throw new RuntimeException("API key and URL must be provided");
		}
